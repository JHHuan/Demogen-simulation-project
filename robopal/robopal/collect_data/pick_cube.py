"""
Panda 机械臂键盘遥操作 Demo - 单立方体抓取实验 (标准数据格式)
功能：
1. 键盘控制末端xyz位置和爪子开闭
...
- 场景: 桌子上有一个绿色立方体（单物体抓取）
- 相机: demogen_camera (机械臂正前方, pos=[1.0, 0, 0.7], fovy=45)

XML路径: /home/hjh/git_code/demogen/robopal/robopal/assets/scenes/pick_single_cube.xml
"""
...
from robopal.robots.panda import PandaSingleCube
