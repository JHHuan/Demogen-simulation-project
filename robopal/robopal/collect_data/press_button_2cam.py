"""
Panda 机械臂键盘遥操作 - Press Button 任务
同时录制两种点云数据
...
物体: buttonbox (MetaWorld press button task)
  - buttonbox 有 freejoint, 可在桌面上拖动
  - button 有 slide joint (btnbox_joint), 按 Y 轴负方向滑动
...
from robopal.robots.panda import PandaButtonBox3cam
